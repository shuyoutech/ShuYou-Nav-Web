...
const loadVideoModelList = () => {
  queryHotDataApi('ai_model_multiImageToVideo').then((res: any) => {
    ...
    <div class="input-panel">
      <div class="panel-body">
        ...
        <div class="middle-box">
          ...
          <!-- 参考图片上传 -->
          <div class="form-section">
            <div class="form-label-with-note">
              <label class="form-label">
                参考图片 (必选)
              </label>
              <div class="form-note">
        ...
        <div v-else-if="generatedVideo" class="video-result">
          <div class="video-container">
            ...
            <div class="video-actions">
              <button @click="downloadVideo" class="action-button download-button">
                <FaIcon name="i-ri:download-line"/>
                <span>下载视频</span>
              </button>
              <button @click="shareVideo" class="action-button share-button">
