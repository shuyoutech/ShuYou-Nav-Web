...
const loadImageModelList = () => {
  queryHotDataApi('ai_model_imageToImage').then((res: any) => {
...
const generateImages = async () => {
  ...
  try {
    let imageParam: ImageModelParam = {
      ...
      imageUrls: formData.referenceImageUrls,
    }
        ...
        <div class="middle-box">
          ...
          <div class="form-section">
            ...
            <div class="upload-area">
              <FaImageUpload
                v-model="formData.referenceImageUrls"
                action="/file/upload"
                :max="modelParams.maxReferenceNum"
                :size="10 * 1024 * 1024"
                :width="100"
                :height="100"
                :ext="['jpg', 'png']"
